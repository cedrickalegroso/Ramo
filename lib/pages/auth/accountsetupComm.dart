...
class AccountCommunitySetup extends StatefulWidget {
  @override
  _AccountCommunitySetupState createState() => _AccountCommunitySetupState();
}

class _AccountCommunitySetupState extends State<AccountCommunitySetup> {
                              ...
                              Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Text(
                                        "Hi! Tell us something about your community.",
                                        style: TextStyle(
                                            fontSize:
                                      ...
                                      TextButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          final _bio = bio.text.trim();
                                          final phone = phoneNumber.text.trim();
                                          bool result = await context
                                              .read<DatabaseService>()
                                              .updateCommunityData(
                                                  _name, _bio, phone, uid);
                                          if (result) {
